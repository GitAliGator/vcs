        ...
        const components = [
            {
                ...
                iframe: 'widgets/introduction/index2.html',
                available: true
            },
            {
                id: 'gas',
            ...
            },
            {
                ...
                iframe: 'widgets/mapping-window/index2.html',
                available: true
            },
            {
                id: 'best-matching',
                ...
                icon: 'fas fa-magic',
                iframe: 'widgets/best-match/best-match.html',
                available: true
            },
            {
                id: 'las',
                ...
                icon: 'fas fa-tasks',
                iframe: 'widgets/las/index2.html',
                available: true
            },
            {
                id: 'nas-distance',
                ...
                icon: 'fas fa-route',
                iframe: 'widgets/distance-nas/distance-nas.html',
                available: true
            },
            {
                id: 'nas-line',
            ...
            },
            {
                ...
                iframe: 'widgets/lct-nas-d/index3.html',
                available: true
            },
            {
                id: 'lct-nas-l',
                ...
                icon: 'fas fa-sliders-h',
                iframe: 'widgets/lct-nas-l/index_t.html',
                available: true
            },
            {
                ...
                iframe: 'widgets/window-regularizer/index2.html',
                available: true
            },
            {
                id: 'nas',
            ...
            },
            {
                ...
                iframe: 'widgets/vcs/index3.html',
                available: true
            }
        ];
